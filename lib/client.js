window.__ModuleLoader__.load({ id: "dsh-preview-plugin", factory: (require) => { var module = { exports: {} }; var exports = module.exports; Object.defineProperty(exports, Symbol.toStringTag, { value: "Module" });
		...
		function PreviewView(props) {
			...
			var [activeUrl, setActiveUrl] = useState(function () { return resolveTarget(port); });
			...
			var applyPort = useCallback(function () {
				...
				if (!trimmed) return;
				setPort(trimmed);
				setActiveUrl(resolveTarget(trimmed));
			...
			var urlPreviewStyle = { fontSize: "11px", color: "#64748b", fontFamily: "monospace", padding: "0 12px", background: "#0f172a", borderTop: "1px solid #334155", lineHeight: "24px", overflow: "hidden", textOverflow: "ellipsis", whiteSpace: "nowrap" };

			var displayUrl = activeUrl ? proxyUrl(activeUrl) : "";
			...
			return h("div", { style: { display: "flex", flexDirection: "column", height: "100%" } },
				h("div", { style: toolbarStyle },
					...
					h("button", { style: refreshBtnStyle, onClick: function () { if (iframeRef.current && activeUrl) iframeRef.current.src = proxyUrl(activeUrl); } }, "\u21bb"),
				),
				activeUrl ? h("div", { style: urlPreviewStyle }, displayUrl) : null,
				!activeUrl ? h("div", { style: { flex: 1, display: "flex", alignItems: "center", justifyContent: "center", color: "#64748b", flexDirection: "column", gap: "8px" } },
